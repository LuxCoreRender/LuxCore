...
IF(FREEIMAGE_ROOT)
  ...
  ENDIF()
  # For LuxCore WindowsCompileDeps structure:
  IF(EXISTS "${FREEIMAGE_ROOT}/x64/Release/lib")
    SET(FREEIMAGE_LIBRARY_DIRS ${FREEIMAGE_LIBRARY_DIRS} ${FREEIMAGE_ROOT}/x64/Release/lib)
  ENDIF()
ENDIF()
