...
//  PARAM_PGIC_ENABLED (and PARAM_PGIC_INDIRECT_ENABLED and PARAM_PGIC_CAUSTIC_ENABLED and PARAM_PGIC_CAUSTIC_USE_ONLY_FOR_SDS)
//  PARAM_HYBRID_BACKFORWARD (and PARAM_HYBRID_BACKFORWARD_GLOSSINESSTHRESHOLD, PARAM_HYBRID_BACKFORWARD_PSR)
