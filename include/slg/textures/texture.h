...
typedef enum {
	...
	POWER_TEX, LESS_THAN_TEX, GREATER_THAN_TEX, SHADING_NORMAL_TEX, POSITION_TEX, 
	SPLIT_FLOAT3, MAKE_FLOAT3, // 34 textures
	// Procedural textures
	...
	MARBLE, DOTS, BRICK, WINDY, WRINKLED, UV_TEX, BAND_TEX, // 41 textures
	// Fresnel textures
