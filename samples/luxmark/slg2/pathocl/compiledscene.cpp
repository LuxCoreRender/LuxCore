...
void CompiledScene::CompileCamera() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile Camera");
...
void CompiledScene::CompileGeometry() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile Geometry");
	...
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Scene geometry compilation time: " << int((tEnd - tStart) * 1000.0) << "ms");
}

void CompiledScene::CompileMaterials() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile Materials");
	...
	const double tEnd = WallClockTime();
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Material compilation time: " << int((tEnd - tStart) * 1000.0) << "ms");
}

void CompiledScene::CompileAreaLights() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile AreaLights");
	...
	const double tEnd = WallClockTime();
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Area lights compilation time: " << int((tEnd - tStart) * 1000.0) << "ms");

}

void CompiledScene::CompileInfiniteLight() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile InfiniteLight");
	...
	const double tEnd = WallClockTime();
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Infinitelight compilation time: " << int((tEnd - tStart) * 1000.0) << "ms");
}

void CompiledScene::CompileSunLight() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile SunLight");
...
void CompiledScene::CompileSkyLight() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile SkyLight");
...
void CompiledScene::CompileTextureMaps() {
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Compile TextureMaps");
	...
	const double tEnd = WallClockTime();
	LM_LOG_ENGINE("[PathOCLRenderThread::CompiledScene] Texture maps compilation time: " << int((tEnd - tStart) * 1000.0) << "ms");
}
