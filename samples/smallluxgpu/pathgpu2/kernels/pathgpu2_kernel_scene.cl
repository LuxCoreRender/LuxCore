...
void GenerateCameraRay(
	...
	const float screenX = min(sampleData[IDX_SCREEN_X] * PARAM_IMAGE_WIDTH, PARAM_IMAGE_WIDTH - 1);
	const float screenY = min(sampleData[IDX_SCREEN_Y] * PARAM_IMAGE_HEIGHT, PARAM_IMAGE_HEIGHT - 1);
#endif
