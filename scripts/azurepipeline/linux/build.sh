...
sudo apt-get install -y wget libtool git cmake g++ flex bison libbz2-dev libgtk-3-dev libgl1-mesa-dev python3-dev python3-pip python3-numpy ocl-icd-opencl-dev
