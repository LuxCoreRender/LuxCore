...
union YYSTYPE
{
#line 636 "/data/img_synth/lux-orig/luxrays/src/luxcore/luxparser/luxparse.y" /* yacc.c:1909  */

char string[1024];
float num;
ParamArray *ribarray;

#line 114 "/data/img_synth/lux-orig/luxrays/src/luxcore/luxparser/luxparse.hpp" /* yacc.c:1909  */
};
