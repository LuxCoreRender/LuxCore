...
Spectrum ColorAberrationPlugin::BilinearSampleImage(const Spectrum *pixels,
	...
	const float tx = Clamp(x - static_cast<float> (x1), 0.f, 1.f);
	const float ty = Clamp(y - static_cast<float> (y1), 0.f, 1.f);
...
//
//		//----------------------------------------------------------------------
//		// ColorAberrationPlugin_FilterX kernel
//		//----------------------------------------------------------------------
//
//		SLG_LOG("[ColorAberrationPlugin] Compiling ColorAberrationPlugin_FilterX Kernel");
//		filterXKernel = new cl::Kernel(*program, "ColorAberrationPlugin_FilterX");
//
...
//
//		//----------------------------------------------------------------------
//		// ColorAberrationPlugin_FilterY kernel
//		//----------------------------------------------------------------------
//
//		SLG_LOG("[ColorAberrationPlugin] Compiling ColorAberrationPlugin_FilterY Kernel");
//		filterYKernel = new cl::Kernel(*program, "ColorAberrationPlugin_FilterY");
//
//		// Set kernel arguments
//		argIndex = 0;
