...
void ImageMapResizeMinMemPolicy::RenderFunc(const u_int threadIndex, ImageMapResizeMinMemPolicy *mmp,
...
void ImageMapResizeMinMemPolicy::Preprocess(ImageMapCache &imc, const Scene *scene, const bool useRTMode) {
	...
	for (size_t i = 0; i < renderThreadCount; ++i)
		renderThreads[i] = new boost::thread(&RenderFunc, i, this, &imc, &imgMapsIndices,
