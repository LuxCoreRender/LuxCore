...
template void ExtMeshCache::save(boost::archive::polymorphic_oarchive &ar, const u_int version) const;
template void ExtMeshCache::load(boost::archive::polymorphic_iarchive &ar, const u_int version);
}
